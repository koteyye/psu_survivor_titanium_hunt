...
export function preloadLevelResources(scene) {
    ...
    // Загружаем атлас текстур для взрывов
    scene.load.atlas('explosions', `images/gameplay/explosions/explosions.png?v=${cacheBuster}`, 'configs/sprites/explosions.json');
    
    // Загружаем атлас текстур для новых взрывов
    scene.load.atlas('good_super', `images/gameplay/explosions/good_super.png?v=${cacheBuster}`, 'configs/sprites/good_super.json');
    
    // Загружаем атлас текстур для плохих блоков и денег
    scene.load.atlas('bad_money', `images/gameplay/explosions/bad_money.png?v=${cacheBuster}`, 'configs/sprites/bad_money.json');
