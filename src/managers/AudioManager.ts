...
export class AudioManager {
  ...
  private scene: any | null = null; // будет заменено на Phaser.Scene после установки типов
  private sounds: Map<string, any> = new Map(); // BaseSound
  private music: Map<string, any> = new Map(); // BaseSound
  private currentMusic: any | null = null; // BaseSound
